...
import com.zhaoyang.vert.core.common.exception.ToolBoxException;
import com.zhaoyang.vert.core.support.*;
...
public class ConvertUtil {
    ...
    public static Object parse(Class<?> clazz, Object value) {
        try {
            ...
            if (Date.class.isAssignableFrom(clazz)) {
                // 判断标准日期
                // 需要加toDate(),不然beetlsql转换date类型的时候会报错----
            ...
            // 未找到可转换的类型，返回原值
            return (StringUtils.isBlank(valueStr)) ? null : value;
        }
    }
    ...
    public static String toStr(Object value, String defaultValue) {
        ...
        if (value instanceof String) {
            ...
            return CollectionKit.arrayToString(value);
        }
    ...
    public static String convertCharset(String str, String sourceCharset, String destCharset) {
        if (StringUtils.isAnyBlank(str, sourceCharset, destCharset)) {
            return str;
        }
